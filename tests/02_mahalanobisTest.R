...
plot(full.dist, type = 'l', ylab = 'Mahalanobis Distance (Full Precision)', xlab = 'Time', main = 'Sample Mahalanobis Distance')
...
plot(full.dist - LoGo.dist, type = 'l', ylab = 'Mahalanobis Distance (Full Precision)', xlab = 'Time', main = 'Sample Mahalanobis Distance')

# Test 3 Sparse precition and liklihood
