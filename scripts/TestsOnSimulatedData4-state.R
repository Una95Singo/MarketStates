...
ICC.ErrorRate.Scene1 = matrix(NA, nrow =length(intra) , ncol = it) # error rates from experiments
...
for (i in 1:length(intra)){
  for (j in 1:it){
    ...
    ICC.ErrorRate.Scene1[i,j] = ICC.Output$ER
    ...
    Noh.Std.Scene1[i+12, j] = round(mean(State4Returns),6)
  }
}})

save(ICC.RandIndex.Scene1, ICC.Mean.Scene1 , ICC.Std.Scene1, Noh.Mean.Scene1, Noh.Std.Scene1, ICC.ErrorRate.Scene1, file ="data/ICCScene1_4S.RData")
load(file ="data/ICCScene1_4S.RData")
...
ICC.Mean.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ICC.Std.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates

ICC.ErrorRate.Scene2 = matrix(NA, nrow =length(intra) , ncol = it) # error rates from experiments


row.names(ICC.RandIndex.Scene2) = intra
row.names(ICC.Mean.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ICC.Std.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")

row.names(Noh.Mean.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(Noh.Std.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
for (i in 1:length(intra)){
  for (j in 1:it){
    ...
    ICC.Output = ICC.cluster(returnsMatrix = dataNoh$stockMatrix, sparseMethod = 2, gamma = 0, K = 4, max.iters = 15)
    ICC.ErrorRate.Scene2[i,j] = ICC.Output$ER
...
save(ICC.RandIndex.Scene2, ICC.Mean.Scene2 , ICC.Std.Scene2, Noh.Mean.Scene2, Noh.Std.Scene2, ICC.ErrorRate.Scene2, file ="data/ICCScene2_4S.RData")
#load(file ="data/ICCScene1_4S.RData")
...
ICC.Mean.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ICC.Std.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates

ICC.ErrorRate.Scene3 = matrix(NA, nrow =length(intra) , ncol = it) # error rates from experiments


row.names(ICC.RandIndex.Scene3) = intra
row.names(ICC.Mean.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ICC.Std.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")

row.names(Noh.Mean.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(Noh.Std.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
for (i in 1:length(intra)){
  for (j in 1:it){
    ...
    ICC.Output = ICC.cluster(returnsMatrix = dataNoh$stockMatrix, sparseMethod = 2, gamma = 0, K = 4, max.iters = 15)
    ICC.ErrorRate.Scene3[i,j] = ICC.Output$ER
...
save(ICC.RandIndex.Scene3, ICC.Mean.Scene3 , ICC.Std.Scene3, Noh.Mean.Scene3, Noh.Std.Scene3, ICC.ErrorRate.Scene3, file ="data/ICCScene3_4S.RData")
...
ICC.Mean.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ICC.Std.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates

ICC.ErrorRate.Scene4 = matrix(NA, nrow =length(intra) , ncol = it) # error rates from experiments


row.names(ICC.RandIndex.Scene4) = intra
row.names(ICC.Mean.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ICC.Std.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")

row.names(Noh.Mean.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(Noh.Std.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
for (i in 1:length(intra)){
  for (j in 1:it){
    ...
    ICC.Output = ICC.cluster(returnsMatrix = dataNoh$stockMatrix, sparseMethod = 2, gamma = 0, K = 4, max.iters = 15)
    ICC.ErrorRate.Scene4[i,j] = ICC.Output$ER
...
save(ICC.RandIndex.Scene4, ICC.Mean.Scene4 , ICC.Std.Scene4,  Noh.Mean.Scene4, Noh.Std.Scene4, ICC.ErrorRate.Scene4, file ="data/ICCScene4_4S.RData")
...
load(file ="data/ICCScene1_4S.RData")
load(file ="data/ICCScene2_4S.RData")
load(file ="data/ICCScene3_4S.RData")
load(file ="data/ICCScene4_4S.RData")


# 1. Open jpeg file
jpeg("images/Findings Chapter/ICCPerformance4State.jpeg", width = 350, height = "350")
...
ASPC.Mean.Scene1 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ASPC.Std.Scene1 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene1 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene1 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates


row.names(ASPC.RandIndex.Scene1) = intra
row.names(ASPC.Mean.Scene1) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ASPC.Std.Scene1) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
save(ASPC.RandIndex.Scene1, ASPC.Mean.Scene1 , ASPC.Std.Scene1, Noh.Mean.Scene1, Noh.Std.Scene1, file ="data/ASPCScene1_4S.RData")
#load(file ="data/ASPCScene1_4S.RData")
...
ASPC.Mean.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ASPC.Std.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene2 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates


row.names(ASPC.RandIndex.Scene2) = intra
row.names(ASPC.Mean.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ASPC.Std.Scene2) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
save(ASPC.RandIndex.Scene2, ASPC.Mean.Scene2 , ASPC.Std.Scene2,Noh.Mean.Scene2, Noh.Std.Scene2, file ="data/ASPCScene2_4S.RData")
...
ASPC.Mean.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ASPC.Std.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene3 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates


row.names(ASPC.RandIndex.Scene3) = intra
row.names(ASPC.Mean.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ASPC.Std.Scene3) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
save(ASPC.RandIndex.Scene3, ASPC.Mean.Scene3 , ASPC.Std.Scene3, Noh.Mean.Scene3, Noh.Std.Scene3, file ="data/ASPCScene3_4S.RData")
...
ASPC.Mean.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
ASPC.Std.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates
Noh.Mean.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) # store mean estimates
Noh.Std.Scene4 = matrix(NA, nrow =length(intra)*4 , ncol = it) #store sd estimates


row.names(ASPC.RandIndex.Scene4) = intra
row.names(ASPC.Mean.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
row.names(ASPC.Std.Scene4) = c("0.25_1", "0.5_1", "0.75_1", "1_1", "0.25_2", "0.5_2", "0.75_2", "1_2", "0.25_3", "0.5_3", "0.75_3", "1_3", "0.25_4", "0.5_4", "0.75_4", "1_4")
...
save(ASPC.RandIndex.Scene4, ASPC.Mean.Scene4 , ASPC.Std.Scene4, Noh.Mean.Scene4, Noh.Std.Scene4, file ="data/ASPCScene4_4S.RData")
#load(file ="data/ASPCScene4.RData")


load(file ="data/ASPCScene1_4S.RData")
load(file ="data/ASPCScene2_4S.RData")
load(file ="data/ASPCScene3_4S.RData")
load(file ="data/ASPCScene4_4S.RData")



# 1. Open jpeg file
#jpeg("images/Findings Chapter/ASPCPerformance4State.jpeg", width = 350, height = "350")
# plot the gamma search results
layout(1,1)
